...
//                            deviceLocation.currentBestLocation.getLongitude(),
    ...
    public void update(LocationMarker testMarker, Frame frame) {
        try {
...
//                            deviceLocation.currentBestLocation.getLongitude(),
            ...
            testMarker.anchorNode = new LocationNode(newAnchor, testMarker, this);
            testMarker.anchorNode.setParent(mArSceneView.getScene());
            testMarker.anchorNode.addChild(testMarker.node);

            if (testMarker.getRenderEvent() != null) {
                testMarker.anchorNode.setRenderEvent(testMarker.getRenderEvent());
            }

            testMarker.anchorNode.setScaleModifier(testMarker.getScaleModifier());
            testMarker.anchorNode.setScalingMode(testMarker.getScalingMode());
            testMarker.anchorNode.setGradualScalingMaxScale(testMarker.getGradualScalingMaxScale());
            testMarker.anchorNode.setGradualScalingMinScale(testMarker.getGradualScalingMinScale());
            testMarker.anchorNode.setHeight(testMarker.getHeight());

            if (minimalRefreshing)
                testMarker.anchorNode.scaleAndRotate();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
